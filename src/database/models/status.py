...
class Status(BaseModel, IdMixin):
    ...
    slug: Mapped[str] = Column(String(20), nullable=False,
                               comment="Описание на англйском для фронта")
    description: Mapped[str] = Column(String(20), nullable=False,
                                      comment="Описание статуса задачи")
    weight: Mapped[int] = Column(Integer(), nullable=False,
                                 comment="Вес статуса для сортировки")
