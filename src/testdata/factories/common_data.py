...
goal_goal_name = [
    "Пройти курс по эффективному общению, активному слушанию и использованию инструментов автоматизации для улучшения скорости ответов.",
    ...
    "Поучаствовать в тренингах по построению командной работы, проведению регулярных встреч для обмена идеями и обратной связи",
...
goal_employee_side_minus = [
    ...
    "Иногда слишком сосредоточен на достижении результатов, что может привести к недостаточной внимательности к потребностям членов команды.",
