...
goal_ids = [
    UUID("d629ea16-7fa5-4ce8-9ae8-34110bf2f9a0"),
    UUID("d94321da-da52-42f1-8eff-c34947ca6af0"),
    UUID("eae53981-8147-45fa-a47f-3d94d17fdde0"),
    UUID("6dd3f92f-2eb4-49c5-895d-ef1794296e9f"),
    UUID("b4be7fce-ee05-4c94-9c40-409174741d44"),
    UUID("d0a4b377-37ec-46c6-bca0-90e737f72f04"),
    UUID("6aa7b714-a50b-483f-b958-63887991d2cf"),
    UUID("ba93111c-e697-4c87-ae20-2ed9221ad20c"),
    UUID("beca460e-6bb5-46a0-97fd-29405b715743"),
    UUID("2a4e651c-38e0-45d0-b8ba-86e9e4d91238"),
]

goal_goal_name = [
    "Пройти курс по эффективному общению, активному слушанию и использованию инструментов автоматизации для улучшения скорости ответов.",  # noqa
    "Пройти тренинг по управлению командой, активному участию в проектах, связанных с руководством.",
    "Завершить онлайн-курс.",
    "Прохождение курсов по SQL, Python и аналитике данных.",
    "Пройти тренинг по коммуникации, поучаствовать в публичных выступлениях",
    "Пройти курс по техникам продаж, анализу успешных кейсов, установке персональных целей продаж",
    "Пройти сертификацию в области кибербезопасности, поучаствовать в тренингах по противодействию кибератакам",
    "Поучаствовать в тренингах по построению командной работы, проведению регулярных встреч для обмена идеями и обратной связи",  # noqa
    "Пройти курс по статистике, машинному обучению и анализу данных.",
    "Разрабать и внедрить программу лояльности, провести мероприятия для привлечения новых клиентов.",
]

goal_employee_side_plus = [
    "Отличное общение с клиентами, умение находить индивидуальный подход",
    "Лидерские качества, способность вдохновлять и мотивировать команду.",
    "Глубокие знания в области финансов, аналитический склад ума.",
    "Высокая техническая грамотность, умение быстро разбираться в сложных технических вопросах.",
    "Убежденность, легкость в установлении контактов, отличные навыки убеждения.",
    "Высокая ответственность, умение анализировать и предвидеть потенциальные угрозы.",
    "Опыт в решении проблем клиентов, терпение, умение работать в стрессовых ситуациях.",
    "Глубокие знания в области анализа данных, умение выявлять тенденции.",
    "Отличные навыки в области маркетинга, креативный подход.",
    "Опыт в построении и оптимизации баз данных, систематичность.",
]

goal_employee_side_minus = [
    "Иногда трудно справляться с высоким объемом запросов, требующих оперативного решения.",
    "Иногда слишком сосредоточен на достижении результатов, что может привести к недостаточной внимательности к потребностям членов команды.",  # noqa
    "Склонность к перфекционизму, что может замедлить процесс принятия решений.",
    "Иногда трудно делиться знаниями с коллегами, что может замедлить общий прогресс команды.",
    "Трудности в принятии отказов, что может повлиять на уровень мотивации.",
    "Трудность в делегировании, что может привести к перегрузке работой.",
    "Иногда трудно переключаться между задачами, что может снизить эффективность работы.",
    "Трудность в презентации результатов, что может усложнить коммуникацию с неспециалистами.",
    "Иногда недостаточная фокусировка на конкретных метриках, что может затруднить оценку эффективности.",
    "Трудность в адаптации к изменениям, что может замедлить внедрение новых технологий.",
]
